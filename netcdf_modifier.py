...
if __name__=="__main__":
    ...
    new_netcdf, excel_dict = nc_modify.modify_conc(
        args.filename,
        args.rowstart,
        args.rowend,
        args.colstart,
    ...
    nc_modify.to_excel(excel_dict, args.outputdir, args.outputname+".xlsx")
    nc_modify.to_netcdf(new_netcdf, args.outputdir, args.outputname+".nc")
